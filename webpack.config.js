...
const config = {
	entry: {
		...
		main: [ './assets/src/js/main.js', './assets/src/css/main.scss',  ]
	},
...
if ( inProduction ) {
	...
	wpPot( {
		package: 'WebergPress',
		domain: 'webergpress',
		destFile: 'languages/webergpress.pot',
		relativeTo: './',
		bugReport: 'https://github.com/mehul0810/webergpress/issues/new',
